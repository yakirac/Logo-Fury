...
/**
 * The timed Difficult level of the game with the cards 
 * having a black background
 * @author Yakira C. Bristol
 *
 */
public class LogoLevel3TimedBlack extends Activity{
	...
	public AlertDialog createDialog(){
		AlertDialog dialog = new AlertDialog.Builder(LogoLevel3TimedBlack.this)
