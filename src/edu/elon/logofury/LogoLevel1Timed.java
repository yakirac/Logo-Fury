...
/**
 * The timed Easy level of the game
 * @author Yakira C. Bristol
 *
 */
public class LogoLevel1Timed extends Activity{
	...
	public AlertDialog createDialog(){
		AlertDialog dialog = new AlertDialog.Builder(LogoLevel1Timed.this)
		...
		dialog.setIcon(R.drawable.lfgmsmall);
	...
	public void startNewLevel(){
		Intent intent = new Intent(LogoLevel1Timed.this, LogoLevel2Timed.class);
