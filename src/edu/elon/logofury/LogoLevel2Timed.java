...
/**
 * The timed Medium level of the game
 * @author Yakira C. Bristol
 *
 */
public class LogoLevel2Timed extends Activity{
	...
	public AlertDialog createDialog(){
		AlertDialog dialog = new AlertDialog.Builder(LogoLevel2Timed.this)
	...
	public void startNewLevel(){
		Intent intent = new Intent(LogoLevel2Timed.this, LogoLevel3Timed.class);
