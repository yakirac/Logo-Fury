...
/**
 * The Easy level of the game with the 
 * cards having a black background
 * @author Yakira C. Bristol
 *
 */
public class LogoLevel1Black extends Activity{
	...
	public AlertDialog createDialog(){
		AlertDialog dialog = new AlertDialog.Builder(LogoLevel1Black.this)
	...
	public void startNewLevel(){
		Intent intent = new Intent(LogoLevel1Black.this, LogoLevel2Black.class);
